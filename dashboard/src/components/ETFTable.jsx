            ...
            {data.length === 0 ? (
              ...
              data.map((etf, idx) => (
                ...
                >
                  ...
                  {/* Name */}
                  <td className="px-4 py-3.5 text-left text-slate-300 font-medium max-w-[180px] lg:max-w-[220px] truncate text-sm whitespace-nowrap" title={etf.Name}>
                    {etf.Name}
                  </td>

                  {/* Change % */}
                  <td className={`px-4 py-3.5 text-right font-semibold text-sm whitespace-nowrap ${
                  ...
                  {/* Vol 1M */}
                  <td className="px-4 py-3.5 text-right text-slate-200 font-mono text-sm whitespace-nowrap">
                    {etf.Vol1M ? `${etf.Vol1M.toFixed(2)}%` : 'N/A'}
                  </td>

                  {/* Dollar Volume */}
                  <td className="px-4 py-3.5 text-right text-slate-300 font-mono text-sm whitespace-nowrap">
                  ...
                  {/* Focus */}
                  <td className="px-4 py-3.5 text-left text-slate-300 text-sm whitespace-nowrap">
                    {etf.Focus || 'N/A'}
                  </td>
                  ...
                  {/* Weight Scheme */}
                  <td className="px-4 py-3.5 text-left text-slate-400 text-sm whitespace-nowrap">
                    {etf.WeightScheme}
                  </td>
